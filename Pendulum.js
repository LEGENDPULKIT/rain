...
holder = Bodies.rectangle(200,20,300,20,holder_options);
...
function draw() {
 ...
 fill ("brown");
  text("Press space bar to oscillate the pendulam to left and right with mouse",10,400);
  text("Press Enter to release the bob",100,450);
